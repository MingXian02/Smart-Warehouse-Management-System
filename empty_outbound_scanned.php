...
<head>
    ...
    <title>Empty Pallet Outbound</title>
    ...
    <style>
        ...
        * {
        ...
        /* ENHANCED BUTTON WITH YOUR SIGNATURE GRADIENT */
        .btn {
            width: 100%;
            padding: 14px;
            /* YOUR SIGNATURE PINK-PURPLE GRADIENT */
...
<div class="container">
    <div style="display:flex; align-items:center; margin-bottom: 20px;">
        ...
        <h2 style="flex:1; text-align:center;">Empty Pallet Outbound</h2>
    </div>

    <div class="form-card">
        <div style="text-align:center; margin-bottom:20px;">
            <div style="font-size:2rem; margin-bottom:10px;">📦</div>
            <h3 style="font-weight:700; color:#1e293b;">Empty Pallet Outbound</h3>
        </div>
        ...
        <div style="margin-bottom:20px;">
            <label style="display:block; font-weight:600; margin-bottom:8px; color:#1e293b;">Quantity to Outbound</label>
            <input type="number" 
                   id="quantityInput"
                   min="1"
        ...
        <button onclick="processOutbound()" class="btn">
            Process Outbound
        </button>
    </div>
</div>
...
function processOutbound() {
    ...
    fetch('empty_outbound_process.php', {
        method: 'POST',
        headers: {
